...
from data.latin_elements import *
...
def make_latin_sentence(sentence_object):
    latin_subject = decline_noun(
        sentence_object["subject"], "subject", sentence_object["subject_number"])

    latin_object = decline_noun(
        sentence_object["object"], "object", sentence_object["object_number"])

    verb_number = sentence_object["subject_number"]
    latin_verb = make_verb(
        sentence_object["verb"]["latin"], verb_number, sentence_object["tense"])
...
def make_english_sentence(sentence_object):
    ...
    english_verb = sentence_object["verb"]["english"][sentence_object["subject_number"]
                                                      ][sentence_object["tense"]]
